...
DPSMate.DB.FixedShieldAmounts = {
	...
	[GetSpellInfo(11974)] = 1000, -- All  -- Power Word: Shield
	[GetSpellInfo(11426)] = 818, -- All -- Ice Barrier
	...
	[GetSpellInfo(10196)] = 570, -- Meele -- Mana Shield
	[GetSpellInfo(16895)] = 2500, -- Frost -- Frost Protection
	[GetSpellInfo(10477)] = 600, -- Frost -- Frost Resistance
	[GetSpellInfo(10178)] = 920, -- Frost -- Frost Ward
	[GetSpellInfo(12561)] = 2500, -- Fire -- Fire Protection
	[GetSpellInfo(10226)] = 920, -- Fire -- Fire Ward
	[GetSpellInfo(16893)] = 2500, -- Nature -- Nature Protection
	[GetSpellInfo(10959)] = 2500, -- Shadow -- Shadow Protection
	[GetSpellInfo(21893)] = 2500, -- Arcane -- Arcane Protection
	[GetSpellInfo(16892)] = 2500, -- Holy -- Holy Protection
}
local AbilityFlags = {
	["fire"] = 3,
	["holy"] = 7,
