...
DPSMate.Options.Options[1]["args"]["aurasgained"] = {
	...
	get = function() return DPSMateSettings["windows"][DPSMate.Options.Dewdrop:GetOpenedParent().Key or 1]["options"][1]["aurasgained"] end,
...
function DPSMate.Modules.AurasGained:GetSettingValues(arr, cbt, k)
	...
	for cat, val in pairs(sortedTable) do
		...
		local str = {[1]="",[2]="",[3]=""}
		if DPSMateSettings["columnsaurasgained"][1] then str[1] = " "..DPSMate:Commas(dmg, k)..p; strt[2] = DPSMate:Commas(tot, k)..p end
